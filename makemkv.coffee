                    ...
                    if code == 0
                                ...
                                if line[0] == 'C' #< Disc Info
                                    ...
                                    switch line[0]
                                        when 'T' #< Track
                                            ...
                                            if track_id not in info_out['data']['tracks']
                                        ...
                                        when 'S' #< Track parts
                                            ...
                                            if 'track_parts' not in info_out['data']['tracks'][track_id]
                                                info_out['data']['tracks'][track_id]['track_parts'] = {}
                                            if track_part_id not in info_out['data']['tracks'][track_id]['track_parts']
                                                info_out['data']['tracks'][track_id]['track_parts'] = {}
                        ...
                        for track_id, track_info in info_out['data']['tracks']
                            for part_id, track_part in track_info['track_parts']
                                info_out['data']['tracks'][track_id]['cnts'][track_part['Type']] += 1
